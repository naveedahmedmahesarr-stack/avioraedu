...
export const metadata: Metadata = {
  title: "About Us — Germany & Europe Education Consultancy",
...
export default async function AboutPage() {
  ...
  return (
    <>
      <PageHeader crumbs={[{ name: "About", path: "/about" }]} eyebrow="About" title="Focused. Honest. European." intro={home.aboutWho} />
