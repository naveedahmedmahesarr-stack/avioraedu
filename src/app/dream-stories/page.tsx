...
export default async function DreamStoriesPage() {
  ...
  return (
    <>
      <PageHeader crumbs={[{ name: "Dream Stories", path: "/dream-stories" }]} eyebrow="Dream Stories" title="Journeys worth telling." intro="Photos, videos and stories from real students — published only with their consent." skyline="PT" />
