...
export default async function HowItWorksPage() {
  ...
  return (
    <>
      <PageHeader crumbs={[{ name: "How It Works", path: "/how-it-works" }]} eyebrow="How it works" title="From first conversation to first semester." intro="A structured, transparent process — with clear explanations of what we do and what universities and authorities decide." skyline="PL" />
