...
export default async function DestinationsPage() {
  ...
  return (
    <>
      <PageHeader crumbs={[{ name: "Destinations", path: "/destinations" }]} eyebrow="Destinations" title="Where students study." intro="Germany is our primary focus. Italy, Poland, Portugal and Austria complete a carefully chosen set of European destinations." skyline="IT" />
