...
export const metadata: Metadata = {
  title: "Reviews",
  description: "Moderated reviews from students supported by AVIORA EDU.",
...
export default async function ReviewsPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Reviews" title="Honest words from real students." intro="Every review is moderated before publication. “Verified” appears only where we have confirmed the reviewer was a client." skyline="AT" />
