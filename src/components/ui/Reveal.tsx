...
export function Reveal({
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      ...
      // The huge top margin makes anything above the viewport (content jumped past) count as visible — no scroll listener needed.
      { rootMargin: "100000px 0px -4% 0px", threshold: 0 },
    );
    io.observe(el);
